...
const selectClass =
  'w-full rounded-md border border-white/10 bg-[var(--ng-surface)] px-3 py-2 text-sm text-slate-200 focus:border-blue-500/50 focus:outline-none focus:ring-1 focus:ring-blue-500/30 [&>option]:text-slate-200';
